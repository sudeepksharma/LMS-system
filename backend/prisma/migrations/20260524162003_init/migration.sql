...
-- AddForeignKey
ALTER TABLE "_CompletedLessons" ADD CONSTRAINT "_CompletedLessons_A_fkey" FOREIGN KEY ("A") REFERENCES "Enrollment"("id") ON DELETE CASCADE ON UPDATE CASCADE;
